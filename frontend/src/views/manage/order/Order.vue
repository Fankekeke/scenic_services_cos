...
<!--        <a-button type="primary" ghost @click="add">新增</a-button>-->
      ...
      <a-table ref="TableInfo"
        ...
        <template slot="operation" slot-scope="text, record">
          <a-icon v-if="record.orderStatus == 0" type="caret-up" @click="audit(record)" title="修改" style="margin-right: 15px"></a-icon>
...
export default {
  ...
  methods: {
    audit (row) {
      this.$get('/cos/order-info/audit', {id: row.id}).then((r) => {
