<template>
  <div :class="[multipage === true ? 'multi-page':'single-page', 'not-menu-page', 'home-page']" style="width: 68%;margin: 0 auto">
    <a-row v-if="newsList.length > 0" style="width: 100%;margin: 0 auto;margin-bottom: 15px;padding: 0">
      <a-col :span="22">
        <a-alert
          banner
          :message="newsContent"
    ...
    <a-row :gutter="8" class="head-info" style="margin-left: -14px;margin-right: -14px">
      <a-card class="head-info-card">
        <a-col :span="12">
          <div class="head-info-avatar">
            <a-avatar shape="square" :size="75" icon="user" :src="'http://127.0.0.1:9527/imagesWeb/' + avatar" />
          </div>
        ...
        <a-col :span="12">
          <div>
            <a-row class="more-info">
              ...
              <a-col :span="4">
                <a-button size="small" @click="edit">个人信息</a-button>
              </a-col>
            </a-row>
          </div>
        </a-col>
    ...
    <a-divider orientation="left">
      <span style="font-size: 13px;margin-top: 15px">社区论坛</span>
    </a-divider>
    <a-card bordered style="margin-left: -14px;margin-right: -14px;padding: 12px;">
      <hotel/>
    </a-card>
